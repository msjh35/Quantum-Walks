...
# Periodic Boundary for y-co
Py = I - ket(N+1)*bra(N+1) - ket(0)*bra(0) + ket(1)*bra(N+1) + ket(N)*bra(0)
...
def graph(final):
    ...
    if plot3D == True:
        ...
        plt.savefig('/Users/Elena/Library/Mobile Documents/com~apple~CloudDocs/Documents/Durham/Dissertation/Plots/Torus_15x15.png')
        plt.show()
